	    ...
	    <main>
	        <div class="container-fluid">
	            ...
	            <div class="col-md-6 col-centered">
    	            ...
    	            <div class="card mb-4">
    	                <div class="card-body">
    	                    <form method="POST" action="<?php echo get_home_url(); ?>/../accesspoint/<?php echo $_GET['id']; ?>">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="model" type="text" class="form-control <?php if(isset($_GET['model'])) echo 'is-invalid'; ?>" name="model" value="<?php if(isset($_GET['oldmodel'])) { echo $_GET['oldmodel']; } ?>" required autocomplete="model" autofocus>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="location" type="string" class="form-control <?php if(isset($_GET['location'])) echo 'is-invalid'; ?>" name="location" value="<?php if(isset($_GET['oldlocation'])) { echo $_GET['oldlocation']; } ?>" required autocomplete="location">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="latitude" type="string" class="form-control <?php if(isset($_GET['latitude'])) echo 'is-invalid'; ?>" name="latitude" value="<?php if(isset($_GET['oldlatitude'])) { echo $_GET['oldlatitude']; } ?>" required autocomplete="latitude">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="longitude" type="string" class="form-control <?php if(isset($_GET['longitude'])) echo 'is-invalid'; ?>" name="longitude" value="<?php if(isset($_GET['oldlongitude'])) { echo $_GET['oldlongitude']; } ?>" required autocomplete="longitude">
                                    </div>
                                </div>
